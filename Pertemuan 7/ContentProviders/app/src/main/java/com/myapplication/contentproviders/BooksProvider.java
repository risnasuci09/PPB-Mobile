package com.myapplication.contentproviders;
...
public class BooksProvider extends ContentProvider {
        static final String PROVIDER_NAME = "com.myapplication.contentproviders";
        ...
        public String getType(Uri uri) {
                switch (uriMatcher.match(uri)) {
                        //---get all books--- case BOOKS:
                        case BOOKS:
                                return "vnd.android.cursor.dir/vnd.learn2develop.books ";
                        //---get a particular book--- case BOOK_ID:
                        case BOOK_ID:
